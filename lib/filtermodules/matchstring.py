...
class MatchString:
    ...
    def check_vulnerability(self, check_name, output, response_code):
        ...
        check_patterns = {
            ...
            "xsser-cross-site-scripting": r"",
            "golismero-ssl-scan": r"",
            "golismero-zone-transfer": r"",
            "golismero-nikto-scan": r"",
            "golismero-brute-subdomains": r"",
            "dnsenum-zone-transfer": r"",
            "dmitry-email-harvesting": r"",
            "nmap-telnet-service": r"",
            "nmap-ftp-service": r"",
            "nmap-stuxnet-worm": r"",
            "webdav-enabled": r"",
            "golismero-fingerprint-web": r"",
            "uniscan-filebrute": r"",
            "uniscan-dirbrute": r"",
